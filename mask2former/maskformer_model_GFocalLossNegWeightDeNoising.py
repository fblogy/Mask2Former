...
from .modeling.criterion_GFLNegWeightDenoising import SetCriterion
from .modeling.matcher_GFLNegWeightDenoising import HungarianMatcher
import time

@META_ARCH_REGISTRY.register()
class MaskFormerGFLNegWeightDeNoising(nn.Module):
    """
    ...
    def from_config(cls, cfg):
        ...
        weight_dict = {"loss_ce": class_weight, "loss_bestce": class_weight, "loss_mask": mask_weight, "loss_dice": dice_weight, "loss_iou" : iou_weight, "loss_mask_dn": mask_weight, "loss_dice_dn": dice_weight, "loss_iou_dn" : iou_weight, "loss_cardinality_error":0.0001, "loss_class_error":0.0001}
