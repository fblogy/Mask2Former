...
from .modeling.criterion_AlignmaskGFLNegWeight import SetCriterion
from .modeling.matcher_AlignmaskGFLNegWeight import HungarianMatcher
# from .modeling.criterion_GFLNegWeight import SetCriterion
# from .modeling.matcher_GFLNegWeight import HungarianMatcher
import time

@META_ARCH_REGISTRY.register()
class MaskFormerAlignmaskGFLNegWeight(nn.Module):
    """
    ...
    def from_config(cls, cfg):
        ...
        weight_dict = {"loss_ce": class_weight, "loss_bestce": class_weight, "loss_mask": mask_weight, "loss_dice": dice_weight, "loss_iou" : iou_weight, "loss_midmask": mask_weight, "loss_middice": dice_weight, "loss_cardinality_error":0.0001, "loss_class_error":0.0001}
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            mask_pred_results = outputs["pred_alignmasks"]
            mask_pred_ious = outputs["pred_logits"]
            # upsample masks
            ...
            processed_results = []
            for mask_cls_result, mask_pred_result, mask_pred_iou, input_per_image, image_size in zip(
                    mask_cls_results, mask_pred_results, mask_pred_ious, batched_inputs, images.image_sizes):
                ...
                if self.instance_on:
                    instance_r = retry_if_cuda_oom(self.instance_inference)(mask_cls_result, mask_pred_result, mask_pred_iou)
    ...
    def instance_inference(self, mask_cls, mask_pred, mask_pred_iou):

        # mask_cls [Q, K]  mask_pred [Q, H, W]

        # mask_pred is already processed to have the same shape as original input
        image_size = mask_pred.shape[-2:]
        # mask_pred_iou = mask_pred_iou.sigmoid()[:, 0] # [N, 1]
        ...
        scores = mask_cls.sigmoid()[:, :-1] #* mask_scores[:, None]
        ...
        # scores_per_image[scores_per_image > 0.1] = 1
