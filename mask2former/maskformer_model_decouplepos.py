...
from .modeling.criterion_decouplepos import SetCriterion
from .modeling.matcher_decouplepos import HungarianMatcher
import time

@META_ARCH_REGISTRY.register()
class MaskFormerDecouplePos(nn.Module):
    """
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            mask_pred_ious = outputs["pred_ious"]
            # upsample masks
    ...
    def instance_inference(self, mask_cls, mask_pred, mask_pred_iou):
        ...
        mask_pred_iou = mask_pred_iou.sigmoid() # [N, 1]
