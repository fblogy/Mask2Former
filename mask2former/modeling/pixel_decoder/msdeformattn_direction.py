...
class MSDeformAttnPixelDecoderDirection(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.dir_features = ResidualUnit(self.mask_dim, self.dir_dim)
    ...
    def forward_features(self, features):
        ...
        dir_features = self.dir_features(out[-1])
        return dir_features, mask_features, out[0], multi_scale_features
