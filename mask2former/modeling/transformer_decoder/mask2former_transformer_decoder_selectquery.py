...
class MultiScaleTransformerDecoderSelectQuery(nn.Module):
    ...
    def forward(self, x, mask_features, mask=None):
        ...
        out = {
            ...
            'pred_encoder_logits': encoder_output_class,
...
@TRANSFORMER_DECODER_REGISTRY.register()
class MultiScaleMaskedTransformerDecoderSelectQuery(MultiScaleTransformerDecoderSelectQuery):
