...
class MultiScaleTransformerDecoderIou(nn.Module):
    ...
    def forward_prediction_heads(self, output, mask_features, attn_mask_target_size):
        ...
        outputs_iou = self.iou_embed(decoder_output)
...
@TRANSFORMER_DECODER_REGISTRY.register()
class MultiScaleMaskedTransformerDecoderIou(MultiScaleTransformerDecoderIou):
