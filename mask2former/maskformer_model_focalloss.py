...
from .modeling.criterion_focal import SetCriterion
from .modeling.matcher_focal import HungarianMatcher
import time

@META_ARCH_REGISTRY.register()
class MaskFormerFocal(nn.Module):
    """
